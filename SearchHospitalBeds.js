...
exports.handler = function(event, context, callback) {
  ...
  const searchOn = event["queryStringParameters"]['search'];
  ...
  request({
    ...
    let parsed = body.feed.entry.filter((e)=>{
      const regex = new RegExp(searchOn,'gmi');
            	const str = e['gsx$state']["$t"]+'---'+e['gsx$hospital']["$t"];
